...
# ---------------------------------------------------------------------------
# Re-exported from the production module so both test and production code can
# call ``build_required_table`` from a single canonical location.
from balatro_rl.engine_jax.curriculum import build_required_table  # noqa: F401
